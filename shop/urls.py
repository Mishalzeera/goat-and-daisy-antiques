...
urlpatterns = [
    ...
    path('mark-invoice-complete/<str:invoice_order_number>/',
         views.mark_invoice_complete, name="mark_invoice_complete"),
    path('delete-invoice/<int:pk>/',
         views.DeleteInvoice.as_view(), name="delete_invoice"),
    ...
    path('set-primary-image/<int:product_id>/<int:image_id>/',
         views.set_primary_image, name='set_primary_image'),
]
